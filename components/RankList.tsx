...
function CardFace({
  ...
  return (
    ...
    >
      <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-mint bg-panel-2 text-center font-display text-[11px] font-semibold leading-none text-paper">
      ...
      {score ? (
        <span
          className={`mt-0.5 font-display text-lg font-semibold ${badgeClass}`}
        >
          {score.points}
        </span>
      ) : handleProps ? (
